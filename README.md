...
```javascript
import { CHANGELOG.md, CODE_OF_CONDUCT.md, CONTRIBUTING.md, CONTRIBUTORS, LICENSE, Makefile, NOTICE, README.md, benchmark, branches.md, deno, docs, examples, lib, node_modules, package.json, test, foo } from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-define-read-only-property@deno/mod.js';
```
